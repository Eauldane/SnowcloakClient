...
public record DownloadStartedMessage(GameObjectHandler DownloadId, IReadOnlyDictionary<string, FileDownloadStatus> DownloadStatus, string? UID = null) : MessageBase;
public record DownloadFinishedMessage(GameObjectHandler DownloadId, string? UID = null) : MessageBase;
