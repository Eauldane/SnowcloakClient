...
public class EditProfileUi : WindowMediatorSubscriberBase
{
        ...
        : base(logger, mediator, "Snowcloak Profile Editor###SnowcloakSyncEditProfileUI", performanceCollectorService)
    {
        ...
        WindowName = "Snowcloak Profile Editor###SnowcloakSyncEditProfileUI";
    ...
    protected override void DrawInternal()
    {
        ...
        if (ElezenImgui.ShowIconButton(FontAwesomeIcon.FileUpload, "Upload new profile picture"))
        {
        ...
        if (ElezenImgui.ShowIconButton(FontAwesomeIcon.Save, "Save Description"))
        {
