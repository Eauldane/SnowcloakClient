...
public partial class IntroUi
{
    ...
    private void DrawAgreementPage()
    {
        ...
        ElezenImgui.WrappedText("Data supplied by third-party plugins usinf the Snowcloak IPC may be relayed to paired users as part of your character state. The Snowcloak developer does not endorse, check, or approve any plugins using the IPC.");
