...
public partial class UiSharedService : DisposableMediatorSubscriberBase
{
    ...
    private const string _notesEnd = "##SNOWCLOAK_USER_NOTES_END##";

    private const string _notesStart = "##SNOWCLOAK_USER_NOTES_START##";
    ...
    public Dictionary<ushort, DalamudUtilService.WorldInfo> WorldInfoData => _dalamudUtil.WorldInfoData.Value;
